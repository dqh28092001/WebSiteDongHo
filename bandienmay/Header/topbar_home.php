...
<div class='header'>
        ...
        <div class='header-top-right'>
            ...
            <div class="dropdown" style="float: right;
                ...
                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1"
                    data-bs-toggle="dropdown" aria-expanded="false" style="padding: 0 1pc;
                                                                            background-color: #3333;
                                                                            border: none;">
                    <i class="fas fa-user" style="margin-right: 10px;"></i><?php echo $_SESSION['name']; ?>
                </button>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="margin: 0px 13px;
    padding: 0 3px;">
                    <li><a class="dropdown-item" href="Components/Login/logout.php">Logout</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class='header-center'>
        ...
        <div class="col-5 agileits_search" style="margin-top: 1pc;">
            <form class="form-inline" action="index.php?quanly=timkiem" method="POST">
                <input class="form-control mr-sm-2" name="search_product" type="search" placeholder="Tìm kiếm sản phẩm"
    ...
    color: #fff;" name="search_button" type="submit">Tìm kiếm</button>
        ...
        <div class='hct-icon'>
            <div class='hct-icon-heart'>
                <span>
                    <a href="index.php?act=like"><i class="fa-solid fa-heart" style="margin-bottom: 2pc;"></i></a>
                </span>
                <span>0</span>
            </div>
            <div class='hct-icon-cart'>
                <span>
                    ...
                    <div class='header-bottom'>
                        <ul id='header-bottom-text'>
                            ...
                            <li class="nav-item active mr-lg-2 mb-lg-0 mb-2">
                                <a class="nav-link" href="index_home.php">Trang chủ
