...
<div class="services-breadcrumb">
    <div class="agile_inner_breadcrumb" style="    margin-top: 3pc;
    ...
    <div class="container py-xl-4 py-lg-2">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 welcome-left">
                <h5><a
                        href="index.php?quanly=chitiettin&id_tin=<?php echo $row_baiviet['baiviet_id'] ?>"><?php echo $row_baiviet['tenbaiviet'] ?></a>
                </h5>
